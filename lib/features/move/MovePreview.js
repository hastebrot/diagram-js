...
export default function MovePreview(
  ...
  function setMarker(element, marker) {
    ...
    [
      MARKER_ATTACH, MARKER_OK, MARKER_NOT_OK,
      MARKER_NEW_PARENT, MARKER_FRAME_NOT_OK
    ].forEach(function(m) {
  ...
  eventBus.on('shape.move.move', LOW_PRIORITY, function(event) {
    ...
    if (target) {
      ...
      } else if (!context.canExecute && isFrameElement(target)) {
        setMarker(target, MARKER_FRAME_NOT_OK);
